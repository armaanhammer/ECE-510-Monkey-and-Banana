...
def getAngleAndDist(robot_info, goal_info):
	...
	angle_diff = abs(robot_info[0] - goal_info[0]) #Find difference between robot and goal angles
	x_diff = goal_info[1] - robot_info[1] #Get the differences between x and y coordinates
	y_diff = goal_info[2] - robot_info[2]
